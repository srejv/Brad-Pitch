...
#define DELAY_FILTER_TYPE	(BASE_ADR + FX_DELAY + PARAM5)
#define DELAY_FILTER_FC		(BASE_ADR + FX_DELAY + PARAM6)	
#define DELAY_FILTER_Q		(BASE_ADR + FX_DELAY + PARAM7)
#define DELAY_DRIVE_IN_GAIN (BASE_ADR + FX_DELAY + PARAM8)
#define DELAY_ATTACK_ONLY_TRESHOLD (BASE_ADR + FX_DELAY + PARAM9)
...
#define PITCHT_GAIN			(BASE_ADR + FX_PITCHT + PARAM6)
#define PITCHT_OFFSET_MS	(BASE_ADR + FX_PITCHT + PARAM7)
...
#define	EQ_LOW_FREQ			(BASE_ADR + FX_EQ + PARAM6)
...
#define FX_REVERB			FX9
#define REVERB_ACTIVE		(BASE_ADR + FX_REVERB + PARAM1)
#define REVERB_MIX			(BASE_ADR + FX_REVERB + PARAM2)
#define REVERB_FEEDBACK		(BASE_ADR + FX_REVERB + PARAM3)
#define REVERB_CUTOFFFREQ	(BASE_ADR + FX_REVERB + PARAM4)
#define REVERB_TIME			(BASE_ADR + FX_REVERB + PARAM5)


#define FX_PITCHF			FX10
