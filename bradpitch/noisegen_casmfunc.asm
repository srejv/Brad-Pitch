			...
			.def _noisefunc
_noisefunc	ZERO	A2			; init A2 for seen manipulation
			MV		A4,A1		; seed in A1
			SHR		A1,17,A1	; shift right 17->bit 17 ro LSB
			ADD		A1,A2,A2	; add A1 to A2 => A2
			SHR		A1,11,A2	; shift rogjt 11->bit 28 to LSB
			ADD		A1,A2,A2	; add again
			SHR		A2,2,A1		; shift right 2->bit 30 to LSB
			ADD		A1,A2,A2	; 
